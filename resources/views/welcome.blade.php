...
<head>
    ...
    <title>Luian Alves Inventory</title>
...
<body id="page-top">
            ...
            <nav id="sidebar"
                ...
                <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
                    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                        ...
                        <div class="sidebar-brand-text mx-3">Luian Alves</div>
                    </a>
                    <hr class="sidebar-divider my-0">

                    {{-- Dashboard --}}
                    <li class="nav-item active pb-3">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseEmp" class="collapse" aria-labelledby="headingBootstrap"
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseSupp" class="collapse" aria-labelledby="headingBootstrap"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseCat" class="collapse" aria-labelledby="headingBootstrap"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseProd" class="collapse" aria-labelledby="headingBootstrap"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    {{-- Expenses --}}
                    <li class="nav-item">
                        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseExpens"
                            aria-expanded="true" aria-controls="collapseExpens">
                            <i class="fab fa-fw fa-wpforms"></i>
                            <span>Expense</span>
                        </a>
                        <div id="collapseExpens" class="collapse" aria-labelledby="headingBootstrap"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    {{-- Customer --}}
                    <li class="nav-item">
                        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseCustm"
                            aria-expanded="true" aria-controls="collapseCustm">
                            <i class="fas fa-fw fa-columns"></i>
                            <span>Customer</span>
                        </a>
                        <div id="collapseCustm" class="collapse" aria-labelledby="headingBootstrap"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <li class="nav-item">
                        ...
                        <div id="collapseOrder" class="collapse" aria-labelledby="headingBootstrap"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                                <router-link class="collapse-item" to="/order">Today Order</router-link>
                                <router-link class="collapse-item" to="/searchorder">Search Order</router-link>
                            </div>
                        </div>
                    </li>
                    {{-- End - Order --}}
                    ...
                    {{-- <li class="nav-item">
                        ...
                        <div id="collapseReport" class="collapse" aria-labelledby="headingBootstrap"
                            data-parent="#accordionSidebar">
                            <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <img class="img-profile rounded-circle" src="{{ asset('images/employee/1629311938.jpeg') }}"
                    ...
                    <div class="container my-auto">
                      <div class="copyright text-center my-auto">
                        <span>Copyright &copy; 2021 - Developed by
                          <b><a href="https://luianalves.com.br/" target="_blank">Luian Alves</a></b>
                        </span>
                      </div>
                    </div>
                </footer>
    ...
    <script>
        // Sempre abaixo do script do jQuery
        let token = localStorage.getItem(
            'token'); // Mostrando sidebar e topbar apenas se estiver logado ("Caso tenha o Token no localStorage")
        if (token) {
            $('#sidebar').css('display', '');
            $('#topbar').css('display', '');
        }
