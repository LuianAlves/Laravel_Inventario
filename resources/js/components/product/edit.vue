            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-left">
                    <h1 class="h4 text-gray-900 pb-4">Product Update</h1>
                  </div>
                  <form
                    class="user"
...
export default {
  ...
  created() {
    ...
    let url = "/api/product/";
    let urlCat = "/api/category/";
    let urlSupp = "/api/supplier/";
    ...
    //category
    axios.get(urlCat).then(({ data }) => (this.categories = data));

    //supplier
    axios.get(urlSupp).then(({ data }) => (this.suppliers = data));
  },
